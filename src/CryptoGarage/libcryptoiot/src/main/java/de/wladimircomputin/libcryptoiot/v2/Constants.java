package de.wladimircomputin.libcryptoiot.v2;
...
public class Constants {
    ...
    public static final String ciot_v2_message_header = "CIOTv2:::";
    public static final String header_hello = "H";
    public static final String header_ack = "A";
    public static final String header_data ="D";
    public static final String header_error = "F";
